...
<div class="col-2">
  ...
  @endif
        ...
        <div class="col-9">
          <br><br><br>
            <h2>Edit  Processed food</h2>
            <a href="../show"><button type="submit" class="btn btn-primary" style="float:right;">BACK</button></a>
            <br><br>
            <form action="{{ route('Processedfood.update', $processedfood->id) }}"  method="POST" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
                ...
                <div class="card-header">
                    <h3>SEO</h3>
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ $processedfood->title }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Keywords</b></label>
                            <input type="text" class="form-control" name="keywords" value="{{ $processedfood->keywords }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Description</b></label>
                            <input type="text" class="form-control" name="description" value="{{ $processedfood->description }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Google Code</b></label>
                            <input type="text" class="form-control" name="google_code"  value="{{ $processedfood->google_code }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Fackbook Code</b></label>
                            <input type="text" class="form-control" name="facrbook_code"  value="{{ $processedfood->facrbook_code }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Orter Code</b></label>
                            <input type="text" class="form-control" name="orteh_code" value="{{ $processedfood->orteh_code }}">
                            </div>
            ...
            <div class="form-group">
              ...
              <input type="test" class="form-control" name="text_title_en" value="{{ $processedfood->text_title_en }}">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1"><b>หัวข้อ</b></label>
              <input type="test" class="form-control" name="text_title_th" value="{{ $processedfood->text_title_th }}">
            </div>

            <div class="form-group">
              <label for="exampleFormControlInput1"><b>Name Product</b></label>
              <input type="test" class="form-control" name="name_product_en" value="{{ $processedfood->name_product_en }}">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1"><b>ชื่อสินค้า</b></label>
              <input type="test" class="form-control" name="name_product_th" value="{{ $processedfood->name_product_th }}">
            </div>

            <div class="form-group">
              <label for="exampleFormControlTextarea1"><b>Detel Product</b></label>
              <textarea class="form-control" name="detel_product_en">{{ $processedfood->detel_product_en }}</textarea>
            </div>
            <div class="form-group">
              <label for="exampleFormControlTextarea1"><b>รายละเอียดสินค้า</b></label>
              <textarea class="form-control" name="detel_product_th">{{ $processedfood->detel_product_th }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="cal-12">
                        <center>
                                ...
                                <a href="/Processedfood/show" class="btn btn-primary">BACK</a>    
                        </center>
            </div>
            </form>      
            <br><br><br><br><br>
