        ...
        <div class="card-header">
            ...
            <div class="form-group">
              ...
              @foreach($brand as $brands)
                <option value="{{ $brands->name_brand_en }}">{{ $brands->name_brand_en }}</option>
              @endforeach  
              </select>
            </div>
            <div class="form-group">
              ...
              @foreach($category as $categorys)
                <option value="{{ $categorys->name_categories }}">{{ $categorys->name_categories }}</option>
              @endforeach  
              </select>
            </div>
            <br>
            <div class="form-group">
              ...
              @foreach($subcategory as $subcategorys)
                <option value="{{ $subcategorys->name_sub_categories }}">{{ $subcategorys->name_sub_categories }}</option>
              @endforeach  
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="ckeditor form-control" name="detel_product_en"></textarea>
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1"><b>Detel Product TH</b></label>
              <textarea class="ckeditor form-control" name="detel_product_th"></textarea>
            </div>
            ...
            <div class="form-group">
              <label for="exampleFormControlTextarea1"><b>images1</b></label>
              <label for="exampleFormControlFile1"> <br> File input MaxSize 400px - 600px / Size less than 1M </b></label>
              <input type="file" name="images_product1" class="form-control-file">
            </div>
            <div class="form-group">
            <label for="exampleFormControlTextarea1"><b>images2</b></label>
              <label for="exampleFormControlFile1"> <br> File input MaxSize 400px - 600px / Size less than 1M </b></label>
              <input type="file" name="images_product2" class="form-control-file">
            </div>
            <div class="form-group">
            <label for="exampleFormControlTextarea1"><b>images3</b></label>
              <label for="exampleFormControlFile1"> <br> File input MaxSize 400px - 600px / Size less than 1M </b></label>
              <input type="file" name="images_product3" class="form-control-file">
            </div>
            <div class="form-group">
            <label for="exampleFormControlTextarea1"><b>images4</b></label>
              <label for="exampleFormControlFile1"> <br> File input MaxSize 400px - 600px / Size less than 1M </b></label>
              <input type="file" name="images_product4" class="form-control-file">
            </div>
            <div class="form-group">
            <label for="exampleFormControlTextarea1"><b>images5</b></label>
              <label for="exampleFormControlFile1"> <br> File input MaxSize 400px - 600px / Size less than 1M </b></label>
            ...
            <div class="form-group">
            <label for="exampleFormControlTextarea1"><b>Attachment </b></label>
