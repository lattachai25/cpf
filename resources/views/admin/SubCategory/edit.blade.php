...
<div class="col-2">
  ...
  @endif
        ...
        <div class="card-header">
            <h3>EDIT SUB Category List</h3>
                </div>
                  <div class="card-body">
                    
                    <div class="form-group">
                      <label for="exampleFormControlInput1"><b>SUB Categories</b></label>
                      <input type="text" class="form-control" name="name_sub_categories"  value="{{ $subcategory->name_sub_categories }}">
                    </div>          
                  </div>
        </div>        
            <br><br>
