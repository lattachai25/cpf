  ...
  @endif
        ...
        <div class="card-header">
            ...
            <div class="form-group">
             ...
             <br><img src="../../files_upload/About/{{$about->images}}" width="100px" style="border:1px solid #000;" alt=""> <br><br>
            ...
            <div class="cal-12">
              <center>
                ...
                <a href="../About"><button type="submit" class="btn btn-primary">CENCEL</button> </a>
              </center>
            </div> 
