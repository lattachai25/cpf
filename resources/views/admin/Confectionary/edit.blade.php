...
<div class="col-2">
  ...
  @endif
        ...
        <div class="col-9">
          <br><br><br>
            <h2>Edit  Confectionary</h2>
            <a href="../show"><button type="submit" class="btn btn-primary" style="float:right;">BACK</button></a>
            <br><br>
            <form action="{{ route('Confectionary.update', $confectionary->id) }}"  method="POST" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
                ...
                <div class="card-header">
                    <h3>SEO</h3>
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ $confectionary->title }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Keywords</b></label>
                            <input type="text" class="form-control" name="keywords" value="{{ $confectionary->keywords }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Description</b></label>
                            <input type="text" class="form-control" name="description" value="{{ $confectionary->description }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Google Code</b></label>
                            <input type="text" class="form-control" name="google_code"  value="{{ $confectionary->google_code }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Fackbook Code</b></label>
                            <input type="text" class="form-control" name="facrbook_code"  value="{{ $confectionary->facrbook_code }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Orter Code</b></label>
                            <input type="text" class="form-control" name="orteh_code" value="{{ $confectionary->orteh_code }}">
                            </div>
            ...
            <div class="form-group">
              ...
              <input type="test" class="form-control" name="text_title_en" value="{{ $confectionary->text_title_en }}">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1"><b>หัวข้อ</b></label>
              <input type="test" class="form-control" name="text_title_th" value="{{ $confectionary->text_title_th }}">
            </div>

            <div class="form-group">
              <label for="exampleFormControlInput1"><b>Name Product</b></label>
              <input type="test" class="form-control" name="name_product_en" value="{{ $confectionary->name_product_en }}">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1"><b>ชื่อสินค้า</b></label>
              <input type="test" class="form-control" name="name_product_th" value="{{ $confectionary->name_product_th }}">
            </div>

            <div class="form-group">
              <label for="exampleFormControlTextarea1"><b>Detel Product</b></label>
              <textarea class="form-control" name="detel_product_en">{{ $confectionary->detel_product_en }}</textarea>
            </div>
            <div class="form-group">
              <label for="exampleFormControlTextarea1"><b>รายละเอียดสินค้า</b></label>
              <textarea class="form-control" name="detel_product_th">{{ $confectionary->detel_product_th }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="cal-12">
                        <center>
                                ...
                                <a href="/Confectionary/show" class="btn btn-primary">BACK</a>    
                        </center>
            </div>
            </form>      
            <br><br><br><br><br>
