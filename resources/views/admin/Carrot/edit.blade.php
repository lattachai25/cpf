  ...
  @endif
        ...
        <div class="col-9">
          <br><br><br>
            ...
            <br><br>
            <form action="{{ route('Carrot.update', $carrot->id) }}"  method="POST" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
                ...
                <div class="card-header">
                    <h3>SEO</h3>
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ $carrot->title }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Keywords</b></label>
                            <input type="text" class="form-control" name="keywords" value="{{ $carrot->keywords }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Description</b></label>
                            <input type="text" class="form-control" name="description" value="{{ $carrot->description }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Google Code</b></label>
                            <input type="text" class="form-control" name="google_code"  value="{{ $carrot->google_code }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Fackbook Code</b></label>
                            <input type="text" class="form-control" name="facrbook_code"  value="{{ $carrot->facrbook_code }}">
                            </div>
                            <div class="form-group">
                            <label for="exampleFormControlTextarea1"><b>Orter Code</b></label>
                            <input type="text" class="form-control" name="orteh_code" value="{{ $carrot->orteh_code }}">
                            </div>
            ...
            <div class="form-group">
              ...
              <input type="test" class="form-control" name="text_title_en" value="{{ $carrot->text_title_en }}">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1"><b>หัวข้อ</b></label>
              <input type="test" class="form-control" name="text_title_th" value="{{ $carrot->text_title_th }}">
            </div>

            <div class="form-group">
              <label for="exampleFormControlInput1"><b>Name Product</b></label>
              <input type="test" class="form-control" name="name_product_en" value="{{ $carrot->name_product_en }}">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1"><b>ชื่อสินค้า</b></label>
              <input type="test" class="form-control" name="name_product_th" value="{{ $carrot->name_product_th }}">
            </div>

            <div class="form-group">
              <label for="exampleFormControlTextarea1"><b>Detel Product</b></label>
              <textarea class="form-control" name="detel_product_en">{{ $carrot->detel_product_en }}</textarea>
            </div>
            <div class="form-group">
              <label for="exampleFormControlTextarea1"><b>รายละเอียดสินค้า</b></label>
              <textarea class="form-control" name="detel_product_th">{{ $carrot->detel_product_th }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="cal-12">
                        <center>
                                ...
                                <a href="/Carrot/show" class="btn btn-primary">BACK</a>    
                        </center>
            </div>
            </form>      
            <br><br><br><br><br>
