...
@section('title', 'SHOW VEGETABLE')
@section('keywords', 'CPFAUSTRALIA')
@section('description', 'SHOW VEGETABLE description CPFAUSTRALIA')
                    ...
                    <div class="row product-flex">
                        <div class="col-md-4 col-sm-12 product-flex-info">
                            <div class="clearfix">
                                ...
                                <h1 class="title" data-title="Showvegetable">Sweet potatoes <small> PRODUCT</small></h1>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="info-box">
                                        <div class="image">
                                            <img src="{{ asset('img/Patane/patane_logo.jpg') }}" alt="Alternate Text" width="80%" />
                                        </div>
                                    </div>
                                </div> <!--/clearfix-->
                        ...
                        <div class="col-md-8 col-sm-12 product-flex-gallery">
                            ...
                            @for($i=1; $i<=2; $i++)
                                <a href="{{ asset('img/Patane/Purple'.$i.'.jpg') }}"><img src="{{ asset('img/Patane/Purple'.$i.'.jpg') }}" alt="" height="250px" /></a>
                            @endfor
                            </div>
                        </div>
                                                        ...
                                                        <div class="figure-grid">
                                                            <div class="image">
                                                                <a href="#productid1" class="mfp-open">
                                                                    <img src="{{ asset('img/Patane/Purple'.$i.'.jpg') }}" alt="" width="360" />
                                                                </a>
                                                            </div>
                                                            <div class="text" style="background: #000000bf; color:#fff;">
                                                                <h4 class="title" style="color:#fff !important;">Sweet potatoes</h4>
                                    ...
                                    <div class="content">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h3>Dimensions</h3>
                                                <p>
                                                    <img class="full-image" src="{{ asset('img/Patane/patane_logo.jpg') }}" alt="Sweet potatoes" width="250" />
                                                </p>
                                            ...
                                            <div class="col-md-8">
                                                <h3>Established in 1886, Sweet potatoes is the oldest</h3>
                                                <p>
                                                ...
                                                All Sweet potatoes cows roam freely and our farmers never produce under intense
        ...
        <div class="popup-main mfp-hide" id="productid1">
            ...
            <div class="product">
                ...
                <div class="owl-product-gallery">
                    @for($i=1; $i<=4; $i++)
                    <img src="{{ asset('img/Dairy/'.$i.'.jpg') }}" alt="" width="640" />
                    @endfor
                </div>
