...
@section('title', 'SHOW FRUT')
@section('keywords', 'CPFAUSTRALIA')
@section('description', 'SHOW FRUT description CPFAUSTRALIA')
                    ...
                    <div class="row product-flex">
                        <div class="col-md-4 col-sm-12 product-flex-info">
                            <div class="clearfix">
                                ...
                                <h1 class="title" data-title="Dairy">Fuit <small>PRODUCT</small></h1>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="info-box">
                                        <div class="image">
                                            <img src="{{ asset('img/Apple/Bravo/bravo_logo.jpg') }}" alt="Alternate Text" width="80%" />
                                        </div>
                                    </div>
                                </div> <!--/clearfix-->
                        ...
                        <div class="col-md-8 col-sm-12 product-flex-gallery">
                            ...
                            @for($i=1; $i<=3; $i++)
                                <a href="/Showfrut"><img src="{{ asset('img/Apple/Bravo/BravoApple'.$i.'.jpg') }}" alt="" height="250px" /></a>
                            @endfor
                            </div>
                        </div>
                                                ...
                                                <div class="col-md-4 col-xs-4">
                                                    <article>
                                                        <div class="figure-grid">
                                                            <div class="image">
                                                                <a href="/Showfrut" class="mfp-open">
                                                                    <img src="{{ asset('img/Apple/Bravo/1.jpg') }}" alt="" width="360" />
                                                                </a>
                                                            </div>
                                    ...
                                    <div class="content">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h3>Dimensions</h3>
                                                <p>
                                                    <img class="full-image" src="{{ asset('img/Apple/Bravo/bravo_logo.jpg') }}" alt="Bravo Apple" width="250" />
                                                </p>
        ...
        <div class="popup-main mfp-hide" id="productid1">
            ...
            <div class="product">
                ...
                <div class="owl-product-gallery">
                    @for($i=1; $i<=4; $i++)
                    <img src="{{ asset('img/Apple/Bravo/'.$i.'.jpg') }}" alt="" width="640" />
                    @endfor
                </div>
