            ...
            <div class="owl-slider owl-slider-fullscreen">
                ...
                <div class="item" style="background-image:url({{ asset('img/Patane/Purple'.$i.'.jpg') }})">
                    <div class="box">
                        ...
                        <h2 class="title animated h1" data-animation="fadeInDown">THE CARROT</h2>
            ...
            <header>
                <div class="row">
                    <div class="col-md-offset-2 col-md-8 text-center">
                        <h2 class="title" style="color:#fff !important;">NEWS CARROT PRODUCT</h2>
                        <div class="text">
                    ...
                    <div class="popup-main popup-main-article mfp-hide" id="interiorId1">
                        ...
                        <div class="product">
                            ...
                            <div class="popup-title">
                                <div class="h1 title">Carrot Product <small>Atisfying meat-lovers worldwide</small></div>
                            </div>
        ...
        <section id="page-products" class="products" style="background-color:#808080 !important;">
            ...
            <div class="container">
                ...
                <header>
                    <div class="row">
                        <div class="col-md-offset-2 col-md-8 text-center">
                            <h2 class="title" style="color:#000 !important;">CARROT products BRAND</h2>
                            <div class="text" style="color:#3c3b3b !important;">
                                <p>Our latest CARROT Product</p>
                            </div>
                            <!-- === box filters === -->
                        </div>
                    </div> <!--/row-->
