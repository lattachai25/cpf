...
@section('title', 'BEVERAGE Product')
            ...
            <div class="owl-slider owl-slider-fullscreen">
                ...
                <div class="item" style="background-image:url({{ asset('assets/img/0'.$i.'.jpg') }})">
                    <div class="box">
                        ...
                        <h2 class="title animated h1" data-animation="fadeInDown">Beverage Meat</h2>
            ...
            <header>
                <div class="row">
                    <div class="col-md-offset-2 col-md-8 text-center">
                        <h2 class="title" style="color:#fff !important;">NEWS Beverage PRODUCT</h2>
                        <div class="text">
        ...
        <section id="page-products" class="products" style="background-color:#808080 !important;">
            ...
            <div class="container">
                ...
                <header>
                    <div class="row">
                        <div class="col-md-offset-2 col-md-8 text-center">
                            <h2 class="title" style="color:#000 !important;">Beverage products BRAND</h2>
                            <div class="text" style="color:#3c3b3b !important;">
                                <p>Our latest Beverage Product</p>
                            </div>
