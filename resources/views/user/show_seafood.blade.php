...
@section('title', 'SHOW SEAFOOD')
@section('keywords', 'CPFAUSTRALIA')
@section('description', 'SHOW SEAFOOD description CPFAUSTRALIA')
                    ...
                    <div class="row product-flex">
                        <div class="col-md-4 col-sm-12 product-flex-info">
                            <div class="clearfix">
                                ...
                                <h1 class="title" data-title="Dairy">Showseafood <small> PRODUCT</small></h1>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="info-box">
                                        <div class="image">
                                            <img src="{{ asset('img/FishTail/Logo_Large_Dark.jpg') }}" alt="Alternate Text" width="80%" />
                                        </div>
                                    </div>
                                </div> <!--/clearfix-->
                        ...
                        <div class="col-md-8 col-sm-12 product-flex-gallery">
                            ...
                            @for($i=1; $i<=2; $i++)
                                <a href=""><img src="{{ asset('img/FishTail/01.jpg') }}" alt="" height="250px" /></a>
                            @endfor
                            </div>
                        </div>
                                                        ...
                                                        <div class="figure-grid">
                                                            <div class="image">
                                                                <a href="#productid1" class="mfp-open">
                                                                    <img src="{{ asset('img/FishTail/4.jpg') }}" alt="" width="360" />
                                                                </a>
                                                            </div>
                                    ...
                                    <div class="content">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h3>Dimensions</h3>
                                                <p>
                                                    <img class="full-image" src="{{ asset('img/FishTail/Logo_Large_Dark.jpg') }}" alt="Brownes Dairy" width="250" />
                                                </p>
        ...
        <div class="popup-main mfp-hide" id="productid1">
            ...
            <div class="product">
                ...
                <div class="owl-product-gallery">
                    @for($i=1; $i<=4; $i++)
                    <img src="{{ asset('img/FishTail/'.$i.'.jpg') }}" alt="" width="640" />
                    @endfor
                </div>
