...
@section('title', 'NAVEL CITRUS Product')
            ...
            <div class="owl-slider owl-slider-fullscreen">
                ...
                <div class="item" style="background-image:url({{ asset('img/Apple/Bravo/BravoApple'.$i.'.jpg') }})">
                    <div class="box">
                        ...
                        <h2 class="title animated h1" data-animation="fadeInDown">THE NAVEL CITRUS</h2>
            ...
            <header>
                <div class="row">
                    <div class="col-md-offset-2 col-md-8 text-center">
                        <h2 class="title" style="color:#fff !important;">NEWS NAVEL CITRUS PRODUCT</h2>
                        <div class="text">
                    ...
                    <div class="popup-main popup-main-article mfp-hide" id="interiorId1">
                        ...
                        <div class="product">
                            ...
                            <div class="popup-title">
                                <div class="h1 title">NAVEL CITRUS Product <small>Atisfying meat-lovers worldwide</small></div>
                            </div>
                ...
                <div class="owl-icons">
                    ...
                    <a href="#">
                        <figure style="padding:10px;">
                            ...
                            <figcaption>NAVEL CITRUS</figcaption>
                        </figure>
                    </a>
                    @endfor
                </div> <!--/owl-icons-->
        ...
        <section id="page-products" class="products" style="background-color:#808080 !important;">
            ...
            <div class="container">
                ...
                <header>
                    <div class="row">
                        <div class="col-md-offset-2 col-md-8 text-center">
                            <h2 class="title" style="color:#000 !important;">NAVEL CITRUS products BRAND</h2>
                            <div class="text" style="color:#3c3b3b !important;">
                                <p>Our latest NAVEL CITRUS Product</p>
                            </div>
                        ...
                        <article>
                            <div class="figure-grid">
                                ...
                                <div class="text" style="background: #000000bf;">
                                    <h2 class="title h4" style="color: #fff !important;">NAVEL CITRUS</h2>
                                </div>
                            </div>
                        </article>
                    </div>
                ...
                <div class="popup-main mfp-hide" id="productid1">
                    ...
                    <div class="product">
                        ...
                        <div class="popup-title">
                            <div class="h1 title">NAVEL CITRUS</div>
                        </div>

                        <!-- === product gallery === -->

                        <div class="owl-product-gallery">
                            <img src="{{ asset('img/Apple/Bravo/01.jpg') }}" alt="" width="640" />
                            <img src="{{ asset('img/Apple/Bravo/02.jpg') }}" alt="" width="640" />
                            <img src="{{ asset('img/Apple/Bravo/03.jpg') }}" alt="" width="640" />
                        </div>
