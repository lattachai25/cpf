                        ...
                        <div class="col-md-offset-2 col-md-8 text-center">
                            ...
                            <div id="box-filters" class="box-filters">
                                ...
                                <figure data-filter=".sofa">
                                    <figcaption>
                                    <i class="flaticon-hen" style="font-size:45px;"></i>
                                        <span>POULTRY</span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure data-filter=".armchair">
                                    <figcaption>
                                    <i class="flaticon-animal" style="font-size:45px;"></i>
                                        <span>BEEF</span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure data-filter=".chair">
                                    <figcaption>
                                    <i class="flaticon-lamb-1" style="font-size:45px;"></i>
                                        <span>LAMB</span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure data-filter=".bedroom">
                                    <figcaption>
                                    <i class="flaticon-deer-1" style="font-size:45px;"></i>
                                        <span>VENISON</span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure data-filter=".bedroom">
                                    <figcaption>
                                    <i class="flaticon-turkey" style="font-size:45px;"></i>
                                        <span>TURKEY</span>
                                    </figcaption>
                                </figure>
