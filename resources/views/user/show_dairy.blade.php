...
@section('title', 'SHOW DAIRY')
@section('keywords', 'CPFAUSTRALIA')
@section('description', 'SHOW DAIRY description CPFAUSTRALIA')
                ...
                <br><br><br><br><br><br>
                    ...
                    <div class="row product-flex">
                        <div class="col-md-4 col-sm-12 product-flex-info">
                            <div class="clearfix">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="info-box">
                                        <div class="image">
                                            <img src="{{ asset('img/Dairy/Brownes_Dairy_logo.jpg') }}" alt="Alternate Text" width="80%" />
                                        </div>
                                    </div>
                                </div> <!--/clearfix-->
                        ...
                        <div class="col-md-8 col-sm-12 product-flex-gallery">
                            ...
                            @for($i=1; $i<=2; $i++)
                                <a href="{{ asset('img/Dairy/'.$i.'.jpg') }}"><img src="{{ asset('img/Dairy/01.jpg') }}" alt="" height="250px" /></a>
                            @endfor
                            </div>
                        </div>
                                                        ...
                                                        <div class="figure-grid">
                                                            <div class="image">
                                                                <a href="#productid1" class="mfp-open">
                                                                    <img src="{{ asset('img/Dairy/4.jpg') }}" alt="" width="360" />
                                                                </a>
                                                            </div>
                                    ...
                                    <div class="content">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h3>Dimensions</h3>
                                                <p>
                                                    <img class="full-image" src="{{ asset('img/Dairy/Brownes_Dairy_logo.jpg') }}" alt="Brownes Dairy" width="250" />
                                                </p>
