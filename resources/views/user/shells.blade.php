...
<div class="wrapper">
        ...
        <section id="page-home" class="header-content">
            ...
            <div class="owl-slider owl-slider-fullscreen">
                ...
                <!-- === slide item === -->
                @for($i=1; $i<=3; $i++)
                <div class="item" style="background-image:url({{ asset('img/jadetiger/01.jpg') }})">
                    <div class="box">
                        <div class="container text-center">
                        <h2 class="title animated h1" data-animation="fadeInDown">THE SHELLS</h2>
        ...
        <section id="page-interiors" class="cards" style="background-color:#000 !important;">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <figure>
                            <figcaption style="background-image:url({{ asset('img/jadetiger/1.jpg') }})">
                            </figcaption>
                    ...
                    <div class="col-md-4">
                        <figure>
                            <figcaption style="background-image:url({{ asset('img/jadetiger/'.$i.'.jpg') }})">
                            </figcaption>
                            <a href="#interiorId1" class="btn btn-clean mfp-open mfp-open-scrollto">Read more</a>
                        </figure>
                    </div>
                ...
                <div class="owl-icons">
                    ...
                    <a href="#">
                        <figure style="padding:10px;">
                            <img src="{{ asset('img/jadetiger/jade_tiger_logo.jpg') }}" width="100%" alt="">
                            <figcaption>SHELLS</figcaption>
                        </figure>
                    </a>
                    @endfor
                </div> <!--/owl-icons-->
            ...
            <div class="container">
                ...
                <div class="popup-main mfp-hide" id="productid1">
                    ...
                    <div class="product">
                        ...
                        <div class="popup-title">
                            <div class="h1 title">FISH</div>
                        </div>

                        <!-- === product gallery === -->

                        <div class="owl-product-gallery">
                            <img src="{{ asset('img/FremantleOctopus/01.jpg') }}" alt="" width="640" />
                            <img src="{{ asset('img/FremantleOctopus/02.jpg') }}" alt="" width="640" />
                            <img src="{{ asset('img/FremantleOctopus/03.jpg') }}" alt="" width="640" />
                        </div>
